...
<div class="card m-2">
   ...
   <div class="card-body">
      <div class="card m-2">
         ...
         <div class="card m-2">
            ...
            <div class="card-body">
               ...
               <form method="get" action="method2">
                  <div class="input-group">
                     <div class="input-group-prepend"><span class="input-group-text">param1</span></div>
                     <input type="text" name="key1" class="form-control" value="문자열">
                  </div>
                  <div class="input-group">
                     <div class="input-group-prepend"><span class="input-group-text">param2</span></div>
                     <input type="text" name="key2" class="form-control" value="5" >
                  </div>
                  <div class="input-group">
                     <div class="input-group-prepend"><span class="input-group-text">param3</span></div>
                     <input type="text" name="param3" class="form-control" value="3.14">
         ...
         <script>
         function requestGet() {
            const value1 = document.form1.param1.value;
            ...
            //요청본문
            //param1 = 문자열&param2=2&param=3.14&param4=true&param5=2030-12-05
            $.ajax({
               url:"method4",
               method:"get",
               data: {
                  param1:value1, //파라미터 명 : 변수 명
                  param2:param2,
                  param3:param3, 
                  param4,  //속성(파라미터)명과 변수명이 일치할경우  요로코롬생략 가능하다.
                  param5
               },
