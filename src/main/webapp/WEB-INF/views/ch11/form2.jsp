...
<div class="card m-2">
	...
	<div class="card-body">
		...
		<form:form method="post" action="form2" modelAttribute="member">
		  <div class="form-group">
		    <label for="mtype">Type</label>
		    <form:select path="mtype" items="${typeList}" class="form-control"/> <!-- items에 들어가있는 항목을 select의 옵션 항목으로 만들겠다 -->
		  </div>
		  
		  <div class="form-group">
		    <label for="mjob">Job</label>
		    <form:select path="mjob" class="form-control"> <!-- path는 dto의 필드 이름 -->
		    	<option value="">---선택하세요---</option>
